...
def process_tile(sample_folder, 
                dapi_channel = 5, 
                diam = 40, 
                expanded_distance = 10,
                big_section = False, 
                ):
    try: 
        print(sample_folder)
        ...
        path = sample_folder+'/preprocessing/ReslicedTiles/Base_1_stitched-'+str(dapi_channel)+'/'
        ...
        save_npz(output_path+"cellpose_segmentation.npz", coo_to_save)
    except:
